            ...
            <div className="Checkout-container">
                ...
                <div className="check-layout">
                    ...
                    <table className="table-check">
                        <thead className="head-check">
                            <tr>
                                <th className="head-id-check" style={{ textAlign: 'center' }}>#</th>
                                <th className="head-image-check" style={{ textAlign: 'left' }}>Sách</th>
                                <th className="head-price-check" style={{ textAlign: 'center' }}>Đơn giá</th>
                                <th className="head-count-check" style={{ textAlign: 'center' }}>Số lượng</th>
                                <th className="head-total-check" style={{ textAlign: 'center' }}>Thành tiền</th>
                            </tr>
                        </thead>
                        <tbody className="body-check">
                            {order.map((item, index) => (
                                <tr key={item.id}>
                                    <td className="id-check">
                                        {index + 1}
                                    </td>
                                    <td className="image-check">
                                        <img className="image-detail-check" src={item.image} alt="Bookimage" />
                                        <div className="text-image-check">{item.name}</div>
                                    </td>
                                    <td className="price-check">
                                        <div className="price-final">{getPriceExpr(item.price)}</div>
                ...
                <div className="confirm-layout">
                    ...
                    <div className="container-confirm">
                        <div className="info-confirm">
                            ...
                            <div className="delivery-confirm">
                                ...
                                <p className="text-confirm">{deliveryMethods[deliveryMethod]}</p>
                            </div>
                            <div className="payment-confirm">
                                <p>Phương thức thanh toán:</p>
                                <p className="text-confirm">{paymentMethods[paymentMethod].text}</p>
                            </div>
                        </div>
                    ...
                    <div className="button-confirm">
                        ...
                        <button className="button-order">Xác nhận đặt hàng</button>
                    </div>
                </div>
            </div>
