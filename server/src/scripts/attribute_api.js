...
app.get('/category-info/:categoryId', async (req, res) => {
    try {
        const accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJTdG9yZUlkIjoiOTg2MDcwIiwiVXNlck5hbWUiOiIiLCJTdG9yZVN0YXR1cyI6IjIiLCJTaG9wVHlwZSI6IjEiLCJTdG9yZUxldmVsIjoiMCIsImV4cCI6MTcxNjExNjI1NSwiaXNzIjoiOTg2MDcwIiwiYXVkIjoiOTg2MDcwIn0.HIPVMdyYCruir2frBsT9PUyBCO5elmE42xYGfWt27V0";
